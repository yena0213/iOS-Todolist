...
//    private init() {}
//    
//    func login(userId: String, userPw: String, completion: @escaping(NetworkResult<Any>) -> Void)
//    {
//        guard let url = URL(string: "https://your-api-url.com/member/sign-in") else {
